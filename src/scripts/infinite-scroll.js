    ...
    try {
      ...
      if (!gridContainer) {
        ...
        gridContainer.className =
          "magazine-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6";
      ...
      const newLoadMoreBtn =
        newPaginationContainer?.querySelector("#load-more-btn");
      ...
      if (newLoadMoreBtn) {
        ...
        if (articleCounter) {
          articleCounter.textContent = `Showing ${newLoadedCount} of ${totalCount} articles`;
        }
      } else {
